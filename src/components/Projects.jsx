...
const Projects = () => {
  ...
  return (
    <section className="min-h-screen py-5 bg-gradient-to-r from-[#263b9b] to-[#E0C3FC] text-white">
      <div className="w-[85%] mx-auto">
        <h3 className=" text-3xl text-[#FEE715FF] mb-5">Projects</h3>
        <div className="flex gap-2">
          ...
          <div className="flex-1 flex gap-5 flex-wrap  justify-center items-center p-5  project-border ">
